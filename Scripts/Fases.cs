using Godot;
using mago_laplace.Scripts.GestorSinais;

namespace mago_laplace.Scripts
{
	public class Fases : Node
	{
		...
		[Export]
		private float tempoMaximo = 180;

		public override void _Ready()
		{

			var gestorSinais = new GestorSinaisFases();
			gestorSinais.ConectarSinais(this);

			var relogio = MetodosUteis.ObterNo<Relogio>(this, "Relogio");
			relogio.SetTempoMax(tempoMaximo);
			relogio.Ativar();
		}
		/*
